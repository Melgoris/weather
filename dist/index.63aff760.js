...
var _weatherData = require("./modules/weather-data");
const timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone, formatZone = Intl.getCanonicalLocales("EN-US");
// console.log(formatZone)
// console.log('formatZone', formatZone)
navigator.geolocation.getCurrentPosition(function({ coords  }) {
    const getWeather = new (0, _weatherData.GetWeather)(coords.latitude, coords.longitude, timeZone);
// console.log(coords)
...
class GetWeather {
    ...
    getWData() {
        return (0, _axiosDefault.default).get(weatherData, {
            params: {
    ...
    parceCurrent({ current_weather , daily , timezone  }) {
        const { apparent_temperature_max: [maxTemp] , apparent_temperature_min: [minTemp]  } = daily;
    ...
    hourlyRender(dataHour) {
        const hourlySection = document.querySelector("[data-hour-section]"), hourlyBlock = document.getElementById("hour-row-template");
        const hourFormater = new Intl.DateTimeFormat(undefined, {
            hour: "numeric"
        }), dayFOrm = new Intl.DateTimeFormat(undefined, {
            weekday: "long"
        });
        ...
        return dataHour.map((time)=>{
            ...
            this.renderValue("time", hourFormater.format(time.hourlyTime), {
                parent: cloneHourly
            });
            this.renderValue("day", dayFOrm.format(time.hourlyTime), {
                parent: cloneHourly
            });
            this.renderValue("temp", time.hourlyAppTemp, {
                parent: cloneHourly
            });
            this.renderValue("fl-temp", time.hourlyFillsLike, {
                parent: cloneHourly
            });
            this.renderValue("wind", time.hourlyWindSpeed, {
                parent: cloneHourly
            });
    ...
    dayRender(dataDay) {
     ...
     <div class="day-card">
      <img src="/icons/${this.MAP_ICON.get(elem.iconCodeDaily)}.svg" data-icon class="weather-icon" />
        <div class="day-card-day" data-date>${new Intl.DateTimeFormat(undefined, {
                weekday: "long"
            }).format(dat)}</div>
...
var Buffer = require("cd5aebec06bf9413").Buffer;
"use strict";
/**
...
},{"cd5aebec06bf9413":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("4e2fc8ccb66dc21d");
var ieee754 = require("63caf528e2456310");
...
},{"4e2fc8ccb66dc21d":"eIiSV","63caf528e2456310":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequire8a8e")
